...
const courses = [
  { code: "BCA", full: "Bachelor of Computer Application", seats: 40, duration: "3 Years", eligibility: "10+2 with Maths / any stream", icon: Monitor },
  { code: "PGDCA", full: "Post Graduate Diploma in Computer Application", seats: 40, duration: "1 Year", eligibility: "Any Graduate", icon: GraduationCap },
  { code: "DCA", full: "Diploma in Computer Applications", seats: 25, duration: "1 Year", eligibility: "10+2 or equivalent", icon: BookOpen },
];

const steps = [
  { title: "Check Eligibility", desc: "Review the eligibility criteria for your desired course (BCA, PGDCA, or DCA)." },
    ...
    <>
      ...
      <section className="relative py-20 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <p className="text-gray-300 max-w-2xl text-lg leading-relaxed">
            Admissions are open for BCA, PGDCA, and DCA programs at GTB College Bilaspur. Seats are limited — apply early.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-extrabold text-[#0f2557] mt-2">Apply to Any of Our Programs</h2>
          </div>
          ...
          <div id="apply" className="bg-[#0f2557] rounded-2xl p-7 shadow-xl text-white">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">Beside Mishra Nursing Home, Near Aarav Construction, Juni Line, Bilaspur (C.G) 495001</p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@gtbcollege.in" className="text-white text-sm hover:text-[#c9a227] transition-colors">info@gtbcollege.in</a>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="mt-5 p-3 bg-white/10 rounded-xl border border-white/10">
              <p className="text-xs text-gray-400">
                <span className="text-[#c9a227] font-semibold">College Code: 233</span> — Affiliated to Atal Bihari Vajpayee Vishwavidyalaya
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 px-4 md:px-8 bg-gray-50 text-center border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a href="http://gtbcollegeofeducation.com/" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 bg-white border border-gray-200 rounded-xl text-[#0f2557] text-sm font-semibold hover:border-[#c9a227] hover:shadow-sm transition-all flex items-center gap-2">
            <ChevronRight size={14} className="text-[#c9a227]" />
